  ...
  return (
    <div className="flex items-center flex-col min-h-screen pb-7 px-2">
      ...
      {links.map((link) => (
        <article
          key={link.id}
          className="flex items-center justify-between w-11/12 max-w-xl rounded p-1 mb-2 select-none"
        ...
        >
          ...
          <div>
            <button
              ...
              className="border border-dashed py-1 px-2 rounded bg-neutral-900"
            >
